...
export function PipelineColumn({
  ...
  return (
    <div className="flex flex-col w-72 min-w-[288px] shrink-0">
      {/* Column Header */}
      <div className="flex items-center justify-between p-3 rounded-t-lg bg-muted/50 border border-b-0">
      ...
      <Droppable droppableId={stage.id}>
        {(provided, snapshot) => (
          <div
            ...
            className={`flex-1 p-2 rounded-b-lg border border-t-0 min-h-[120px] overflow-y-auto transition-colors ${
